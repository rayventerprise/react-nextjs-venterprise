...
startups and large enterprises. He is a full stack engineer first, working
across TypeScript, React, Next.js, Node, Laravel, Ruby on Rails, and Python,
with substantial AI/ML platform experience from Amazon, where he built the internal compute
