...
// @ts-ignore
import {Checks, Database, DeviceMobile, HardDrives, PaintBrush} from '@phosphor-icons/react/dist/ssr'
import {TechBlock} from './TechBlock'

export const TechBreakdown = () => {
  return <div className="flex flex-col flex-grow">
    <div className="flex w-full justify-between flex-col md:flex-row space-y-6 md:space-y-0">
      ...
      <TechBlock name="Infrustructure" icon={<Database size={24}/>}>
